...
class Compra(Base):
    ...
    # ----- Campo para embeddings (pgvector) -----
    vector = Column(Vector(1536))  # tamanho do embedding que você planejar
    ...
    fontes_orcamentarias = relationship(
        "FonteOrcamentaria", back_populates="compra", cascade="all, delete-orphan"
    )
